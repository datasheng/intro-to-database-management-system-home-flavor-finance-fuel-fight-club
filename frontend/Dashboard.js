              ...
              <div className="home-desktop-menu" data-thq="thq-navbar-nav">
                  <nav className="home-links">
                      ...
                      <Dropdown>
                          ...
                          <Dropdown.Item onClick={() => navigate('/login')} >FinanceFuel</Dropdown.Item>
                          </Dropdown.Menu>
                      </Dropdown>
                      </span>
                      <span className="home-nav bodySmall" onClick={() => navigate('/Schedule')}>Book Appointment</span>
        ...
        <div className="heroContainer home-hero1">
          <div className="home-container01">
            ...
            <div className="home-btn-group">
              <button className="buttonFilled" onClick={() => navigate('/Schedule')}>Book Now</button>
